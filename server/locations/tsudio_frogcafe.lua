...
Jobs['frogperson'] = {
    ...
    closedShops = {
        {ped = 'Nc_Pepe_CS', loc = vector4(1113.9280, -643.7979, 55.8214, 233.5980), label = 'Frog Cafe'}
    },
    closedShopItems = {
        bzzz_sugary_macaron_a = {name = 'Macaron', price = 250},
        bzzz_sugary_macaron_b = {name = 'Macaron', price = 250},
        bzzz_sugary_cake_b = {name = 'Strawberry cake', price = 250},
        bzzz_sugary_tiramisu_a = {name = 'Tiramisu', price = 250},
        bzzz_sugary_mochi_a = {name = 'Lilly Mochi', price = 250},
        bzzz_uwuprops_drink_a = {name = 'Frosty Iced Coffee', price = 100},
        bzzz_uwuprops_drink_b = {name = 'Lillypad Iced Coffee', price = 100},
        bzzz_uwuprops_drink_c = {name = 'Princess Iced Coffee', price = 100},
        bzzz_uwuprops_drink_d = {name = 'Definitely Not Bloody Iced Coffee', price = 100},
        bzzz_uwuprops_coffee_a = {name = 'Cute Coffee', price = 100},
        bzzz_uwuprops_cappuccino_a = {name = 'Cute Cappuccino', price = 100},
        bzzz_uwuprops_donut_a = {name = 'Sweet Donut', price = 250},
    },
    craftingStations = {
        soda = {        
            { anim = 'uncuff', give = {}, take = {bzzz_uwuprops_drink_a = 1}, progtext = 'Mixing' },
            { anim = 'uncuff', give = {}, take = {bzzz_uwuprops_drink_b = 1}, progtext = 'Mixing' },
            { anim = 'uncuff', give = {}, take = {bzzz_uwuprops_drink_c = 1}, progtext = 'Mixing' },
            { anim = 'uncuff', give = {}, take = {bzzz_uwuprops_drink_d = 1}, progtext = 'Mixing' },
        },
        coffee = {
            { anim = 'uncuff', give = {},    take = { bzzz_uwuprops_coffee_a = 1 }, progtext = 'Brewing' },
            { anim = 'uncuff', give = {},    take = { bzzz_uwuprops_cappuccino_a = 1 }, progtext = 'Brewing' },
        },
        fryer = { -- donuts mainly       
            { anim = 'uncuff', give = {flour = 1, milk = 1, egg = 1},  take = { bzzz_uwuprops_donut_a = 1 }, progtext = 'Cooking' },
        },
        ...
        bake = { -- bake
            { anim = 'uncuff', give = { flour = 1, milk = 1, egg = 1 }, take = { bzzz_sugary_macaron_a = 1 }, progtext = 'Using' },
            { anim = 'uncuff', give = { flour = 1, milk = 1, egg = 1 }, take = { bzzz_sugary_macaron_b = 1 }, progtext = 'Using' },
            { anim = 'uncuff', give = { flour = 1, milk = 1, egg = 1 }, take = { bzzz_sugary_cake_b = 1 }, progtext = 'Using' },
            { anim = 'uncuff', give = { flour = 1, milk = 1, egg = 1 }, take = { bzzz_sugary_tiramisu_a = 1 }, progtext = 'Using' },
            { anim = 'uncuff', give = { flour = 1, milk = 1, egg = 1 }, take = { bzzz_sugary_mochi_a = 1 }, progtext = 'Using' },
        }            
    },
    catering = {
            commission = 0.2,
    ...
    locations = {
        Crafter = {
            ...
            --    loc = vector3(-1195.3722, -897.3842, 13.91), l = 2.0, w = 0.7, lwr = 0.5, upr = 0.5, r = 180, job = jobloc},
